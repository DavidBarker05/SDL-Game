...
INT32 Math::Pow(INT32 base, INT32 exponent) { return std::pow(base, exponent); }

FLOAT32 Math::Abs(FLOAT32 num) { return std::abs(num); }

INT32 Math::Abs(INT32 num) { return std::abs(num); }

FLOAT32 Math::Floor(FLOAT32 num) { return std::floor(num); }
...
FLOAT32 Math::SinRad(FLOAT32 angleRad) { return std::sin(angleRad); }

FLOAT32 Math::ASinDeg(FLOAT32 _sin) { return std::asin(_sin) * RadToDeg; }

FLOAT32 Math::ASinRad(FLOAT32 _sin) { return std::asin(_sin); }

FLOAT32 Math::CosDeg(FLOAT32 angleDeg) { return std::cos(angleDeg * DegToRad); }

FLOAT32 Math::CosRad(FLOAT32 angleRad) { return std::cos(angleRad); }

FLOAT32 Math::ACosDeg(FLOAT32 _cos) { return std::acos(_cos) * Math::RadToDeg; }

FLOAT32 Math::ACosRad(FLOAT32 _cos) { return std::acos(_cos); }

FLOAT32 Math::TanDeg(FLOAT32 angleDeg) { return std::tan(angleDeg * DegToRad); }

FLOAT32 Math::TanRad(FLOAT32 angleRad) { return std::tan(angleRad); }

FLOAT32 Math::ATanDeg(FLOAT32 _tan) { return std::atan(_tan) * RadToDeg; }

FLOAT32 Math::ATanRad(FLOAT32 _tan) { return std::atan(_tan); }

FLOAT32 Math::ATan2Deg(FLOAT32 x, FLOAT32 y) { return std::atan2(y, x) * RadToDeg; }

FLOAT32 Math::ATan2Rad(FLOAT32 x, FLOAT32 y) { return std::atan2(y, x); }
